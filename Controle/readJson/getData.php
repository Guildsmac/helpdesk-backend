    ...
    if(!$isSpecified) {
        if (strcmp($table, "funcionario") == 0)
            ...
            echo json_encode(DBRead("hel_pessoa as peOne, hel_pessoa as peTwo, hel_protocolo as pr, hel_categoria as c",
                ...
                "peOne.nomePessoa as nomeFuncionario, peTwo.nomePessoa as nomeCliente, pr.data, c.nome"));
    }else{
        ...
        if (strcmp($table, "funcionario") == 0)
            ...
            echo json_encode(DBRead("hel_pessoa as peOne, hel_pessoa as peTwo, hel_protocolo as pr, hel_categoria as c",
                ...
                "peOne.nomePessoa as nomeFuncionario, peTwo.nomePessoa as nomeCliente, pr.data, pr.tempoDuracao, pr.detalhes, c.nome"));
    }
